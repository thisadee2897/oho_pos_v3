...
class _OrderProductState extends State<OrderProduct> {
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          if (count == countOption) {
            ...
            AlertDialogs()
                .alertWarning(context, 'กรุณาเลือกตัวเลือกเพิ่มเติมให้ครบ');
          }
        },
        child: Container(
          decoration: BoxDecoration(
  ...
  Padding slip() {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          border: Border.all(color: const Color(0xffaab6fe), width: 2),
          borderRadius: BorderRadius.circular(40),
        ),
        child: Column(
                                ...
                                Transform.scale(
                                  ...
                                  child: Radio(
                                    value: int.parse(remarkData[index]
                                        .optionItem![indexs]['option_items_id']
                                        .toString()),
                                    groupValue: option[index]['option_id'],
                                    onChanged: (values) {
                                      setState(() {
                                        option[index]['option_id'] = values!;
                                      });
                                    },
                                  ),
                                ),
